...
export const chapter1Missions: MissionSeed[] = [
  {
    ...
    order: 1,
    title: "닫히지 않은 인사",
    description: "Debugrove 환영 스크립트가 실행조차 되지 않습니다. 이름 한 줄을 입력받은 뒤 `Debugrove 이름`을 출력해야 하지만 print 함수의 닫는 괄호 `)`가 빠져 SyntaxError가 발생합니다. 괄호를 닫아 정확한 환영 문구를 출력하세요.",
    difficulty: 1,
    isBoss: false,
    bugTypeSlug: "syntax",
    ...
    tests: [
        {
            "order": 1,
            "input": "Alice\n",
            "expectedOutput": "Debugrove Alice",
            "isHidden": false
        },
        {
            "order": 2,
            "input": "민수\n",
            "expectedOutput": "Debugrove 민수",
            "isHidden": false
        },
        {
            "order": 3,
            "input": "Python\n",
            "expectedOutput": "Debugrove Python",
            "isHidden": true
        }
    ],
    hints: ["에디터에서 `print` 줄의 괄호 개수를 세어 보세요. `(` 와 `)` 가 짝이 맞나요?","두 번째 인자인 `name` 뒤에 닫는 괄호 `)` 가 빠져 있습니다.","`print(\"Debugrove\", name)` 로 함수 호출을 완성하세요."],
  ...
  },
  {
    ...
    tests: [
        ...
        },
        {
            "order": 2,
            "input": "Debugrove\n",
            "expectedOutput": "Hello Debugrove",
            "isHidden": false
        },
        {
            "order": 3,
  ...
  },
  {
    ...
    tests: [
        ...
        },
        {
            "order": 2,
            "input": "Debugrove\n",
            "expectedOutput": "He said \"Debugrove\"",
            "isHidden": false
        },
        {
            "order": 3,
